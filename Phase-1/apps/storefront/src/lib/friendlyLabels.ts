const THEME_TITLES: Record<string, string> = {
  ...
  FitAndSizeUncertainty: "Fit and size",
  SizeFitUncertainty: "Fit and size",
  ComparisonParalysis: "Choosing between saved items",
  CompareAndDecide: "Choosing between saved items",
  StylingOccasionMismatch: "What to wear for an occasion",
  StyleOccasionUncertainty: "What to wear for an occasion",
